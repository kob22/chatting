...
#         request = factory.get(reverse('topic-messages-list'))
...
#         request = factory.get(reverse('topic-messages-detail', args=(1,)))
...
#         with mock.patch('django.utils.timezone.now', mock.Mock(return_value=mocked_date)):
#             request = factory.post(reverse('topic-messages-list'), self.message)
#             response = message_view(request)
#             response.render()
#
...
#         request = factory.put(reverse('topic-messages-detail', args=(self.messages[0]['id'],)), msg_to_send)
#         response = message_view(request, pk=1)
#         response.render()
#
#         self.assertEqual(response.status_code, status.HTTP_200_OK)
...
#         request = factory.delete(reverse('topic-messages-detail', args=(1,)))
...
#         factory = APIRequestFactory()
#         msg_view = MessageViewSet.as_view({'delete': 'destroy'})
#         request = factory.delete(reverse('topic-messages-detail', args=(2,)))
#         response = msg_view(request, pk=1)
#         response.render()
#
